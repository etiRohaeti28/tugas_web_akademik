...
<!DOCTYPE html>
    <head>
        ...
        <!-- file stylesheet ini mengandung gaya (styles) yang diperlukan untuk mengatur tata letak dan
        penampilan ikon-ikon dari font awesome--> 
        ...
        <script src="../assets/js/lquery.min.js" type="text/javascript"></script>
        <script src="../assets/js/datatables.min.js"></script>
        <!-- <scripts src="../js/datatables.min.js"></script>      --> 
...
<div class="page-logo">
<img class="logo" src="../assets/image/stmik.png.png"/></div>
            ...
            <br>
            <a href="?page=nilai"><i class="fa fa-graduation-cap fa-icon" aria-hidden="true"></i>Daftar Kuliah</a>
        </div>
        <div class="page-content">
            <div class="content-header">
                <span><?php echo $_SESSION['username']?></span>
                <img src="../assets/image/user.png.jpg" class="icon" />
