...
<div class="tabel-page">
    ...
    <div class="search-box">
        <form method="get" action="#">
            ...
            $sql = "SELECT * form dosen";
            $result = mysql_query($conn, $sql);
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)){
            ?>
                <option value="<? echo $row['ID_Dosen']?>">
    ...
    <table id="list-data" class="display">
        ...
        <?php
            ...
            $sql = "SELECT * from dosen as d
                        ...
                        INNER JOIN mata_kuliah as m.ID_Matkul = me.ID_Matkul
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="jadwal/jadwal_mengajar_update.php">
                                ...
                                <!-- Ruangan --> 
                                <label for="fdosen">Ruangan <input list="ruangan" type="text" value="
